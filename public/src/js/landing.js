...
for (i=0; i<80; i++){
    ...
    TweenLite.set(Div,{attr:{class:'dot'},x:I?90:210,y:130,scale:R(0.1,1.2),opacity:R(0.5,1),backgroundColor:C});
...
var tl = new TimelineMax()
    ...
    .to('.Capsule',1,{y:'+=5',repeat:-1,yoyo:true,ease:Sine.easeInOut})
