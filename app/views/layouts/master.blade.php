...
@if (App::environment('local'))
    ...
    <!-- Charts -->
    <script type="text/javascript" src="/src/plugins/charts-flot/jquery.flot.min.js"></script>
    <!-- Flot Main File -->
    <script type="text/javascript" src="/src/plugins/charts-flot/jquery.flot.pie.min.js"></script>
    <!-- Flot Pie Chart Plugin -->
    <script type="text/javascript" src="/src/plugins/charts-flot/jquery.flot.stack.min.js"></script>
    <!-- Flot Stacked Charts Plugin -->
    <script type="text/javascript" src="/src/plugins/charts-flot/jquery.flot.orderBars.min.js"></script>
    <!-- Flot Ordered Bars Plugin-->
    <script type="text/javascript" src="/src/plugins/charts-flot/jquery.flot.resize.min.js"></script>
    <!-- Flot Responsive -->
    <script type="text/javascript" src="/src/plugins/charts-flot/jquery.flot.tooltip.min.js"></script>
    <!-- Flot Tooltips -->
    <script type="text/javascript" src="/src/plugins/charts-flot/jquery.flot.spline.js"></script>
    <!-- Flot Curved Lines -->
    ...
    <!-- Switchery -->
    <script type="text/javascript" src="/src/plugins/easypiechart/jquery.easypiechart.js"></script>
...
@else
    ...
    <script type="text/javascript" src="/dist/plugins/charts-flot/jquery.flot.stack.min.js"></script>
    <script type="text/javascript" src="/dist/plugins/charts-flot/jquery.flot.orderBars.min.js"></script>
    <script type="text/javascript" src="/dist/plugins/charts-flot/jquery.flot.resize.min.js"></script>
    <script type="text/javascript" src="/dist/plugins/charts-flot/jquery.flot.tooltip.min.js"></script>
    <script type="text/javascript" src="/dist/plugins/charts-flot/jquery.flot.spline.js"></script>
