                        ...
                        <div class="container-fluid">
                            ...
                            <div data-widget-group="group1">
                                ...
                                <div class="panel panel-default" data-widget='{"draggable": "false"}'>
                                    {{ Form::open(['route' => 'dashboard.nickname', 'id' => 'validate-form', 'class' => 'form-horizontal']) }}
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                {{ Form::text('nickname', null, ['class' => 'form-control', 'placeholder' => 'Nickname', 'id' => 'Nickname', 'required' => true]) }}
                                            </div>
                                        </div>
